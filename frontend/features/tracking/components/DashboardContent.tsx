...
function ErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl border border-[#E8E0D7] p-12 flex flex-col items-center text-center">
        ...
        <button
          onClick={onRetry}
          className="text-sm text-[#7B9E87] font-medium hover:text-[#6A8E77] transition-colors"
        >
          Try again
        </button>
      </div>
...
export function DashboardContent() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-[#2A2522]">Dashboard</h1>
